...
C++/WinRT also attempts to implement modules without using std modules, which also causes issues, as will be explained further later. However, this is not C++/WinRT's fault, as STL's module support was only completed in 2024.
