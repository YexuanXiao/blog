...
category: blog
---
C++的模板是现代C++开发必不可少的一部分。C++11引入了别名模板的特性，使模板嵌套模板能更加方便。
...
1. 由于模板是需要知道参数类型才能实例化的，而C语言的define宏和typedef都无法做到**将参数传递给原来的模板**，所以C++增加了别名模板这一特性，**使using也支持类型推导**，从而实现 模板 + 别名。
...
C++11-17模板核心知识（十二）—— 模板的模板参数Template Template Parameters
</a>
<span>
侯捷C++新标准 - C++11/14
</span>
